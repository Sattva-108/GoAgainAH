...
function OFAuctionFrameDeathClips_OnLoad()
    ...
    prev:SetScript("OnEnter", function(self)
        GameTooltip:SetOwner(self, "ANCHOR_TOPLEFT")
        GameTooltip:SetPoint("BOTTOMLEFT", self, "TOPLEFT", 0, 5)
        GameTooltip:AddLine(L["ЛКМ: Пред. страница. ПКМ: Назад 10 стр."])
        GameTooltip:AddLine(L["SHIFT+ЛКМ: Первая стр."])
        GameTooltip:SetScale(1.1)
        GameTooltip:Show()
    end)
    prev:SetScript("OnLeave", function(self)
        GameTooltip:Hide()
    end)
    ...
    next:SetScript("OnEnter", function(self)
        ...
        GameTooltip:SetPoint("BOTTOMRIGHT", self, "TOPRIGHT", 0, 5)
        GameTooltip:AddLine(L["ЛКМ: След. страница. ПКМ: Вперёд 10 стр."])
        GameTooltip:AddLine(L["SHIFT+ЛКМ: Последняя стр."])
        GameTooltip:SetScale(1.1)
        GameTooltip:Show()
    end)
